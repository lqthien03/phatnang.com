! function(c, u, g, b) {
            ...
            g.extend(m.prototype, {
                    init: function() {
                        ...
                        a.closeExisting && g.fancybox.close(!0),
                            g("body").addClass("fancybox-active"), !g.fancybox.getInstance() && !1 !== a.hideScrollbar && !g.fancybox.isMobile && u.body.scrollHeight > c.innerHeight && (g("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (c.innerWidth - u.documentElement.clientWidth) + "px;}</style>"),
                                g("body").addClass("compensate-for-scrollbar")),
                            n = "",
                            g.each(a.buttons, function(t, e) {
                                n += a.btnTpl[e] || ""
                            }),
                            e = g(o.translate(o, a.baseTpl.replace("{{buttons}}", n).replace("{{arrows}}", a.btnTpl.arrowLeft + a.btnTpl.arrowRight))).attr("id", "fancybox-container-" + o.id).addClass(a.baseClass).data("FancyBox", o).appendTo(a.parentEl),
                            o.$refs = {
                                container: e
                    ...
                    addContent: function(t) {
                        ...
                        g.each(n, function(t, e) {
                                var n, o, a, i, s, r = {},
                                    c = {};
                                g.isPlainObject(e) ? c = (r = e).opts || e : "object" === g.type(e) && g(e).length ? (c = (n = g(e)).data() || {},
                                    ...
                                    i = r.src || "", !o && i && ((a = i.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (o = "video",
                                        r.opts.video.format || (r.opts.video.format = "video/" + ("ogv" === a[1] ? "ogg" : a[1]))) : i.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? o = "image" : i.match(/\.(pdf)((\?|#).*)?$/i) ? (o = "iframe",
                                        r = g.extend(!0, r, {
                                            contentType: "pdf",
                                            opts: {
                                                iframe: {
                                    ...
                                    "ajax" === r.type && 1 < (s = i.split(/\s+/, 2)).length && (r.src = s.shift(),
                                        r.opts.filter = s.shift()),
                            ...
                            Object.keys(l.slides).length && (l.updateControls(),
                                (e = l.Thumbs) && e.isActive && (e.create(),
                                    e.focus()))
                    },
                    addEvents: function() {
                        var o = this;
                        o.removeEvents(),
                            ...
                            i.on("orientationchange.fb resize.fb", function(t) {
                                t && t.originalEvent && "resize" === t.originalEvent.type ? (o.requestId && l(o.requestId),
                    ...
                    jumpTo: function(t, o) {
                        ...
                        if (!(u.isDragging || u.isClosing || u.isAnimating && u.firstRun)) {
                            if (t = parseInt(t, 10), !(a = u.current ? u.current.opts.loop : u.opts.loop) && (t < 0 || f <= t))
                                return !1;
                            if (e = u.firstRun = !Object.keys(u.slides).length,
                                ...
                                u.prevPos = u.currPos,
                                i = u.createSlide(t),
                                1 < f && ((a || i.index < f - 1) && u.createSlide(t + 1),
                                ...
                                e)
                                return i.opts.animationEffect && o && u.$refs.container.css("transition-duration", o + "ms"),
                            ...
                            r = g.fancybox.getTranslate(s.$slide),
                                ...
                                n ? (d = r.left - (s.pos * r.width + s.pos * s.opts.gutter),
                                    g.each(u.slides, function(t, e) {
                    ...
                    createSlide: function(t) {
                        var e, n, o = this;
                        return n = (n = t % o.group.length) < 0 ? o.group.length + n : n, !o.slides[t] && o.group[n] && (e = g('<div class="fancybox-slide"></div>').appendTo(o.$refs.stage),
                    ...
                    scaleToActual: function(t, e, n) {
                        ...
                        c.isAnimating || c.isMoved() || !d || "image" != l.type || !l.isLoaded || l.hasError || (c.isAnimating = !0,
                            ...
                            a = .5 * u - .5 * p,
                            i = .5 * f - .5 * h,
                            u < p && (0 < (a = o.left * s - (t * s - t)) && (a = 0),
                                a < u - p && (a = u - p)),
                            f < h && (0 < (i = o.top * r - (e * r - e)) && (i = 0),
                                i < f - h && (i = f - h)),
                            c.updateCursor(p, h),
                    ...
                    scaleToFit: function(t) {
                        var e, n = this,
                            o = n.current,
                            a = o.$content;
                        n.isAnimating || n.isMoved() || !a || "image" != o.type || !o.isLoaded || o.hasError || (n.isAnimating = !0,
                            g.fancybox.stop(a),
                            e = n.getFitPos(o),
                            n.updateCursor(e.width, e.height),
                            g.fancybox.animate(a, {
                                top: e.top,
                                left: e.left,
                    ...
                    getFitPos: function(t) {
                        var e, n, o, a, i = t.$content,
                            ...
                            l = {};
                        return !!(t.isLoaded && i && i.length) && (e = g.fancybox.getTranslate(this.$refs.stage).width,
                            ...
                            r && c || (r = e,
                                c = n),
                            e - .5 < (r *= o = Math.min(1, e / r, n / c)) && (r = e),
                            n - .5 < (c *= o) && (c = n),
                            "image" === t.type ? (l.top = Math.floor(.5 * (n - c)) + parseFloat(s.css("paddingTop")),
                                l.left = Math.floor(.5 * (e - r)) + parseFloat(s.css("paddingLeft"))) : "video" === t.contentType && (r / (a = t.opts.width && t.opts.height ? r / c : t.opts.ratio || 16 / 9) < c ? c = r / a : c * a < r && (r = c * a)),
                            l.width = r,
                            l.height = c,
                            l)
                    },
                    ...
                    updateSlide: function(t, e) {
                        var n = this,
                            ...
                            s = t.$slide;
                        n.adjustCaption(t),
                            o && (a || i || "video" === t.contentType) && !t.hasError && (g.fancybox.stop(o),
                    ...
                    isMoved: function(t) {
                        ...
                        return !!o && (n = g.fancybox.getTranslate(this.$refs.stage),
                            e = g.fancybox.getTranslate(o.$slide), !o.$slide.hasClass("fancybox-animated") && (.5 < Math.abs(e.top - n.top) || .5 < Math.abs(e.left - n.left)))
                    },
                    updateCursor: function(t, e) {
                        ...
                        i && !a.isClosing && a.Guestures && (s.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-zoomOut fancybox-can-swipe fancybox-can-pan"),
                            ...
                            n ? s.addClass("fancybox-can-pan") : o && ("zoom" === i.opts.clickContent || g.isFunction(i.opts.clickContent) && "zoom" == i.opts.clickContent(i)) ? s.addClass("fancybox-can-zoomIn") : i.opts.touch && (i.opts.touch.vertical || 1 < a.group.length) && "video" !== i.contentType && s.addClass("fancybox-can-swipe"))
                    },
                    isZoomable: function() {
                    ...
                    isScaledDown: function(t, e) {
                        var n = !1,
                            o = this.current,
                            a = o.$content;
                        return t !== b && e !== b ? n = t < o.width && e < o.height : a && (n = (n = g.fancybox.getTranslate(a)).width < o.width && n.height < o.height),
                            n
                    },
                    canPan: function(t, e) {
                        var n = this.current,
                            o = null,
                            a = !1;
                        return "image" === n.type && (n.isComplete || t && e) && !n.hasError && (a = this.getFitPos(n),
                                t !== b && e !== b ? o = {
                                    width: t,
                                    height: e
                    ...
                    loadSlide: function(n) {
                        ...
                        if (!n.isLoading && !n.isLoaded) {
                            ...
                            switch (t = n.type,
                                ...
                                case "ajax":
                                    a.showLoading(n),
                                        o = g.ajax(g.extend({}, n.opts.ajax.settings, {
                                            url: n.src,
                    ...
                    setImage: function(e) {
                        ...
                        setTimeout(function() {
                            ...
                            n.checkSrcset(e),
                            e.$content = g('<div class="fancybox-content"></div>').addClass("fancybox-is-hidden").appendTo(e.$slide.addClass("fancybox-slide--image")), !1 !== e.opts.preload && e.opts.width && e.opts.height && e.thumb && (e.width = e.opts.width,
                    ...
                    setBigImage: function(e) {
                        ...
                        e.$image = o.one("error", function() {
                                ...
                                e.$ghost || (n.resolveImageSlideSize(e, this.naturalWidth, this.naturalHeight),
                                        n.afterLoad(e)),
                                    n.isClosing || (e.opts.srcset && ((t = e.opts.sizes) && "auto" !== t || (t = (1 < e.width / e.height && 1 < i.width() / i.height() ? "100" : Math.round(e.width / e.height * 100)) + "vw"),
                    ...
                    setIframe: function(a) {
                        var i, e = this,
                            s = a.opts.iframe,
                            r = a.$slide;
                        a.$content = g('<div class="fancybox-content' + (s.preload ? " fancybox-is-hidden" : "") + '"></div>').css(s.css).appendTo(r),
                            r.addClass("fancybox-slide--" + a.contentType),
                            a.$iframe = i = g(s.tpl.replace(/\{rnd\}/g, (new Date).getTime())).attr(s.attr).appendTo(a.$content),
                    ...
                    setContent: function(t, e) {
                        ...
                        this.isClosing || (this.hideLoading(t),
                            ...
                            t.$slide.empty(),
                            (n = e) && n.hasOwnProperty && n instanceof g && e.parent().length ? ((e.hasClass("fancybox-content") || e.parent().hasClass("fancybox-content")) && e.parents(".fancybox-slide").trigger("onReset"),
                    ...
                    afterLoad: function(t) {
                        ...
                        e.isClosing || (t.isLoading = !1,
                            ...
                            e.hideLoading(t), !t.opts.smallBtn || t.$smallBtn && t.$smallBtn.length || (t.$smallBtn = g(e.translate(t, t.opts.btnTpl.smallBtn)).appendTo(t.$content)),
                    ...
                    adjustCaption: function(t) {
                        ...
                        s.toggleClass("fancybox-caption--separate", i),
                            i && a && a.length && (o.pos !== n.currPos ? ((e = s.clone().appendTo(s.parent())).children().eq(0).empty().html(a),
                                    r = e.outerHeight(!0),
                    ...
                    adjustLayout: function(t) {
                        ...
                        i.isLoaded && !0 !== i.opts.disableLayoutFix && (i.$content.css("margin-bottom", ""),
                            i.$content.outerHeight() > i.$slide.height() + .5 && (o = i.$slide[0].style["padding-bottom"],
                                ...
                                0 < parseFloat(a) && (e = i.$slide[0].scrollHeight,
                    ...
                    revealContent: function(t) {
                        ...
                        return t.isRevealed = !0,
                            ...
                            o = parseInt(t.forcedDuration === b ? o : t.forcedDuration, 10), !l && t.pos === i.currPos && o || (e = !1),
                            "zoom" === e && (t.pos === i.currPos && o && "image" === t.type && !t.hasError && (c = i.getThumbPos(t)) ? r = i.getFitPos(t) : e = "fade"),
                            "zoom" === e ? (i.isAnimating = !0,
                                r.scaleX = r.width / c.width,
                                r.scaleY = r.height / c.height,
                                "auto" == (a = t.opts.zoomOpacity) && (a = .1 < Math.abs(t.width / t.height - c.width / c.height)),
                                a && (c.opacity = .1,
                                    r.opacity = 1),
                                ...
                                e ? (g.fancybox.stop(s),
                                    ...
                                    void g.fancybox.animate(s, "fancybox-slide--current", o, function() {
                                        s.removeClass(n).css({
                                                transform: "",
                                                opacity: ""
                                            }),
                                    ...
                                    d || !l || "image" !== t.type || t.hasError || t.$content.hide().fadeIn("fast"),
                    ...
                    complete: function() {
                        ...
                        !n.isMoved() && e.isLoaded && (e.isComplete || (e.isComplete = !0,
                                ...
                                g.each(n.slides, function(t, e) {
                                    e.pos >= n.currPos - 1 && e.pos <= n.currPos + 1 ? o[e.pos] = e : e && (g.fancybox.stop(e.$slide),
                                        e.$slide.off().remove())
                                }),
                                n.slides = o),
                            n.isAnimating = !1,
                    ...
                    focus: function(t, e) {
                        ...
                        })).length ? (o = n.index(u.activeElement),
                            t && t.shiftKey ? (o < 0 || 0 == o) && (t.preventDefault(),
                                n.eq(n.length - 1).trigger("focus")) : (o < 0 || o == n.length - 1) && (t && t.preventDefault(),
                    ...
                    close: function(t, e) {
                        ...
                        return !l.isClosing && (!(l.isClosing = !0) === l.trigger("beforeClose", t) ? (l.isClosing = !1,
                            ...
                            d.$slide.removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"), !0 !== t ? g.fancybox.stop(d.$slide) : n = !1,
                            ...
                            "zoom" === n ? (g.fancybox.stop(a),
                                ...
                                "auto" == (s = d.opts.zoomOpacity) && (s = .1 < Math.abs(d.width / d.height - c.width / c.height)),
                                s && (c.opacity = 0),
                                g.fancybox.setTranslate(a, r),
                                p(a),
                                g.fancybox.animate(a, c, o, u)) : n && o ? g.fancybox.animate(d.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + n, o, u) : !0 === t ? setTimeout(u, o) : u(), !0))
                    },
                    cleanUp: function(t) {
                        var e, n, o, a = this,
                        ...
                        a.current.$slide.trigger("onReset"),
                            ...
                            a.current.opts.backFocus && (i && i.length && i.is(":visible") || (i = a.$trigger),
                                i && i.length && (n = c.scrollX,
                                    o = c.scrollY,
                                    i.trigger("focus"),
                    ...
                    trigger: function(t, e) {
                        ...
                        if (i ? o.unshift(i) : i = a,
                            o.unshift(a),
                            g.isFunction(i.opts[t]) && (n = i.opts[t].apply(i, o)), !1 === n)
                            return n;
                ...
                g.fancybox = {
                    ...
                    getInstance: function(t) {
                        ...
                        return e instanceof m && ("string" === g.type(t) ? e[t].apply(e, n) : "function" === g.type(t) && t.apply(e, n),
                            e)
                    },
                    open: function(t, e, n) {
                        return new m(t, e, n)
                    ...
                    use3d: (t = u.createElement("div"),
                        c.getComputedStyle && c.getComputedStyle(t) && c.getComputedStyle(t).getPropertyValue("transform") && !(u.documentMode && u.documentMode < 11)),
                    ...
                    setTranslate: function(t, e) {
                        var n = "",
                            o = {};
                        if (t && e)
                            return e.left === b && e.top === b || (n = (e.left === b ? t.position().left : e.left) + "px, " + (e.top === b ? t.position().top : e.top) + "px",
                        ...
                        g.isFunction(o) && (a = o,
                            ...
                            e.on(d, function(t) {
                                (!t || !t.originalEvent || e.is(t.originalEvent.target) && "z-index" != t.originalEvent.propertyName) && (r.stop(e),
                                    ...
                                    g.isPlainObject(n) ? n.scaleX !== b && n.scaleY !== b && r.setTranslate(e, {
                                        top: n.top,
                                        left: n.left,
                            ...
                            g.isPlainObject(n) ? (n.scaleX !== b && n.scaleY !== b && (delete n.width,
                                    delete n.height,
                ...
                s.on("mousedown mouseup focus blur", e, function(t) {
                    switch (t.type) {
                        ...
                        case "focusin":
                            g(e).removeClass(n),
                                g(this).is(o) || g(this).is("[disabled]") || g(this).addClass(n);
                            break;
                        case "focusout":
                            g(e).removeClass(n)
                    }
    ...
    function y(t, e) {
        ...
        t && t.isDefaultPrevented() || (t.preventDefault(),
            ...
            (a = g.fancybox.getInstance()) && a.$trigger && a.$trigger.is(n) || (i = e.selector ? g(e.selector) : (o = n.attr("data-fancybox") || "") ? (i = t.data ? t.data.items : []).length ? i.filter('[data-fancybox="' + o + '"]') : g('[data-fancybox="' + o + '"]') : [n],
                (s = g(i).index(n)) < 0 && (s = 0),
    ...
    var a = {
        ...
        load: function(t) {
            ...
            "youtube" === t && delete window.onYouTubeIframeAPIReady,
                (e = p.fancybox.getInstance()) && (n = e.current.$content.find("iframe"),
...
function(g, c, b) {
    ...
    var m = g.requestAnimationFrame || g.webkitRequestAnimationFrame || g.mozRequestAnimationFrame || g.oRequestAnimationFrame || function(t) {
        ...
        l = function(t) {
            if (t.is('a,area,button,[role="button"],input,label,select,summary,textarea,video,audio,iframe') || b.isFunction(t.get(0).onclick) || t.data("selectable"))
                return !0;
        ...
        u = function(t) {
            for (var e, n, o, a, i, s = !1; e = t.get(0),
                void 0,
                n = g.getComputedStyle(e)["overflow-y"],
                o = g.getComputedStyle(e)["overflow-x"],
                a = ("scroll" === n || "auto" === n) && e.scrollHeight > e.clientHeight,
                i = ("scroll" === o || "auto" === o) && e.scrollWidth > e.clientWidth, !(s = a || i) && (t = t.parent()).length && !t.hasClass("fancybox-stage") && !t.is("body");)
            ;
            return s
        },
        n = function(t) {
            ...
            e.instance = t,
                ...
                e.destroy(),
                e.$container.on("touchstart.fb.touch mousedown.fb.touch", b.proxy(e, "ontouchstart"))
        };
    n.prototype.destroy = function() {
                ...
                e.realPoints = e.startPoints = d(t),
                    e.startPoints.length && (a.touch && t.stopPropagation(),
                        ...
                        ((e.opts || e.canPan) && (n.is(e.$stage) || e.$stage.find(n).length) || (n.is(".fancybox-image") && t.preventDefault(),
                            b.fancybox.isMobile && n.parents(".fancybox-caption").length)) && (e.isScrollable = u(n) || u(n.parent()),
                            b.fancybox.isMobile && e.isScrollable || t.preventDefault(),
                            (1 === e.startPoints.length || a.hasError) && (e.canPan ? (b.fancybox.stop(e.$content),
        ...
        n.prototype.onSwipe = function(t) {
            ...
            if (!0 !== n)
                "x" == n && (0 < a.distanceX && (a.instance.group.length < 2 || 0 === a.instance.current.index && !a.instance.current.opts.loop) ? o += Math.pow(a.distanceX, .8) : a.distanceX < 0 && (a.instance.group.length < 2 || a.instance.current.index === a.instance.group.length - 1 && !a.instance.current.opts.loop) ? o -= Math.pow(-a.distanceX, .8) : o += a.distanceX),
                a.sliderLastPos = {
                ...
                if (a.canTap = !1,
                    i.group.length < 2 && a.opts.vertical ? a.isSwiping = "y" : i.isDragging || !1 === a.opts.vertical || "auto" === a.opts.vertical && 800 < b(g).width() ? a.isSwiping = "x" : (e = Math.abs(180 * Math.atan2(a.distanceY, a.distanceX) / Math.PI),
                ...
                i.isDragging = a.isSwiping,
                    ...
                    b.each(i.slides, function(t, e) {
                        ...
                        b.fancybox.stop(e.$slide),
                            ...
                            e.pos === i.current.pos && (a.sliderStartPos.top = n.top - o.top,
        ...
        n.prototype.limitMovement = function() {
            ...
            return a = r < h ? f + l : f,
                ...
                0 < l && t < a && (a = t - 1 + Math.pow(-t + f + l, .8) || 0),
                l < 0 && a < n && (a = n + 1 - Math.pow(n - f - l, .8) || 0),
                0 < d && e < i && (i = e - 1 + Math.pow(-e + p + d, .8) || 0),
        ...
        n.prototype.endSwiping = function(t, e) {
            ...
            n.sliderLastPos = null,
                "y" == t && !e && 50 < Math.abs(n.distanceY) ? (b.fancybox.animate(n.instance.current.$slide, {
                        top: n.sliderStartPos.top + n.distanceY + 150 * n.velocityY,
                        opacity: 0
                    }, 200),
                    o = n.instance.close(!0, 250)) : s && 0 < n.distanceX ? o = n.instance.previous(300) : s && n.distanceX < 0 && (o = n.instance.next(300)), !1 !== o || "x" != t && "y" != t || n.instance.centerSlide(200),
        ...
        n.prototype.endZooming = function() {
            ...
            a.contentLastPos && (t = a.contentLastPos.left,
                ...
                s < a.canvasWidth && r < a.canvasHeight ? a.instance.scaleToFit(150) : s > i.width || r > i.height ? a.instance.scaleToActual(a.centerPointStartX, a.centerPointStartY, 150) : (n = a.limitPosition(t, e, s, r),
        ...
        n.prototype.onTap = function(n) {
            var t, o = this,
                ...
                l = function(t) {
                    var e = i.opts[t];
                    if (b.isFunction(e) && (e = e.apply(a, [i, n])),
                        e)
                        switch (e) {
                            case "close":
            ...
            if ((!n.originalEvent || 2 != n.originalEvent.button) && (e.is("img") || !(r > e[0].clientWidth + e.offset().left))) {
                if (e.is(".fancybox-bg,.fancybox-inner,.fancybox-outer,.fancybox-container"))
                    ...
                    if (!a.current.$content || !a.current.$content.find(e).addBack().filter(e).length)
                        return;
                    t = "Content"
                }
                if (o.tapped) {
                    ...
                    o.tapX = r,
                    o.tapY = c,
                    i.opts["dblclick" + t] && i.opts["dblclick" + t] !== i.opts["click" + t] ? o.tapped = setTimeout(function() {
                        o.tapped = null,
                            a.isAnimating || l("click" + t)
                    }, 500) : l("click" + t);
                return this
            }
        },
    ...
    r.extend(n.prototype, {
        ...
        r(s).on({
            ...
            "afterKeydown.fb": function(t, e, n, o, a) {
                var i = e && e.SlideShow;
                !i || !n.opts.slideShow || 80 !== a && 32 !== a || r(s.activeElement).is("button,a,input") || (o.preventDefault(),
                    i.toggle())
            },
    ...
    n(i).on({
        "onInit.fb": function(t, e) {
            o ? e && e.group[e.currIndex].opts.fullScreen ? (e.$refs.container.on("click.fb-fullscreen", "[data-fancybox-fullscreen]", function(t) {
                ...
                e.FullScreen = a) : e && e.$refs.toolbar.find("[data-fancybox-fullscreen]").hide() : e.$refs.toolbar.find("[data-fancybox-fullscreen]").remove()
        },
        "afterKeydown.fb": function(t, e, n, o, a) {
    ...
    i.extend(o.prototype, {
            ...
            create: function() {
                var n, t = this,
                    ...
                    o = t.opts.parentEl,
                    a = [];
                t.$grid || (t.$grid = i('<div class="' + s + " " + s + "-" + t.opts.axis + '"></div>').appendTo(e.$refs.container.find(o).addBack().filter(o)),
            ...
            focus: function(t) {
                var e, n, o = this,
                    a = o.$list,
                    i = o.$grid;
                o.instance.current && (n = (e = a.children().removeClass(r).filter('[data-index="' + o.instance.current.index + '"]').addClass(r)).position(),
    ...
    s.extend(!0, s.fancybox.defaults, {
        ...
        s(t).on("click", "[data-fancybox-share]", function() {
            var t, e, n, o, a = s.fancybox.getInstance(),
                i = a.current || null;
            i && ("function" === s.type(i.opts.share.url) && (t = i.opts.share.url.apply(i, [a, i])),
                e = i.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === i.type ? encodeURIComponent(i.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(t)).replace(/\{\{url_raw\}\}/g, (n = t,
                    o = {
                        "&": "&amp;",
                        "<": "&lt;",
                        ">": "&gt;",
    ...
    a.escapeSelector || (a.escapeSelector = function(t) {
        ...
        a(function() {
            !1 !== a.fancybox.defaults.hash && (a(s).on({
                    "onInit.fb": function(t, e) {
                        var n, o;
                        !1 !== e.group[e.currIndex].opts.hash && (n = r(),
                            (o = c(e)) && n.gallery && o == n.gallery && (e.currIndex = n.index - 1))
                    },
                    "beforeShow.fb": function(t, e, n, o) {
                        var a;
                        n && !1 !== n.opts.hash && (a = c(e)) && (e.currentHash = a + (1 < e.group.length ? "-" + (n.index + 1) : ""),
                            i.location.hash !== "#" + e.currentHash && (o && !e.origHash && (e.origHash = i.location.hash),
                                e.hashTimer && clearTimeout(e.hashTimer),
                                e.hashTimer = setTimeout(function() {
                                    "replaceState" in i.history ? (i.history[o ? "pushState" : "replaceState"]({}, s.title, i.location.pathname + i.location.search + "#" + e.currentHash),
                                            o && (e.hasCreatedHistory = !0)) : i.location.hash = e.currentHash,
                                        e.hashTimer = null
                                }, 300)))
                    },
