! function(a, b) {
    ...
    var s = function(a) {
        ...
        c = ea.support = {},
            ...
            m = ea.setDocument = function(a) {
                ...
                return e !== n && 9 === e.nodeType && e.documentElement ? (n = e,
                    ...
                    r = [],
                    q = [],
                    (c.qsa = $.test(e.querySelectorAll)) && (ha(function(a) {
            ...
            d = ea.selectors = {
                            ...
                            function(b, c, i) {
                                ...
                                if (q) {
                                    ...
                                    if (o = [g ? q.firstChild : q.lastChild],
                                        ...
                                        for (;
                                            (l = ++n && l && l[p] || (m = n = 0) || o.pop()) && ((h ? l.nodeName.toLowerCase() !== r : 1 !== l.nodeType) || !++m || (s && ((l[u] || (l[u] = {}))[a] = [w, m]),
                                                l !== b));)
                                    ;
                ...
                pseudos: {
                    ...
                    lang: ga(function(a) {
                        return W.test(a || "") || ea.error("unsupported lang: " + a),
        ...
        return oa.prototype = d.filters = d.pseudos,
            ...
            i = ea.select = function(a, b, e, f) {
                ...
                return (n || h(a, o))(f, b, !p, e, aa.test(a) && na(b.parentNode) || b),
                    e
            },
        ...
        m.extend({
            ...
            ready: function(a) {
                if (!0 === a ? !--m.readyWait : !m.isReady) {
                    ...
                    m.isReady = !0, !0 !== a && --m.readyWait > 0 || (H.resolveWith(y, [m]),
    ...
    a.ActiveXObject && m(a).on("unload", function() {
        ...
        (Xb = k.ajax = !!Xb) && m.ajaxTransport(function(a) {
    ...
    m.offset = {
        ...
        m.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var a = this.offsetParent || bc; a && !m.nodeName(a, "html") && "static" === m.css(a, "position");)
                        a = a.offsetParent;
                    return a || bc
                })
            }
