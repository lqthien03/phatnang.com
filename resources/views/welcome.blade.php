...
<meta property="og:description" content="VI TÍNH PHÁT NĂNG | Vi Tính Bình Dương chuyên linh kiện máy tính giá tốt, linh kiện vi tính chất lượng nguồn sẵn, thanh lý phòng net, thanh lý phòng net giá cao, thanh lý phòng nét giá tốt nhất..." />
...
<div class="header">
    ...
    <div class="slideshow">
        ...
        <div class="owl-carousel owl-theme owl-slideshow">
                            <div>
                    <a href="" target="_blank" title=""><img onerror="this.src='thumbs/958x384x1/assets/images/noimage.png';" src="thumbs/958x384x1/upload/photo/slider-4501.jpg" alt=""/></a>
                </div>
                            <div>
    ...
    <div class="footer-powered">
        <div class="wrap-content d-flex flex-wrap align-items-center justify-content-between">
            ...
            <p class="statistic animate__animated animate__fadeInRight wow">
                ...
                <span>Tuần: 612</span>
                <b>|</b>
                <span>Tháng: 1631</span>
                <b>|</b>
                <span>Tổng: 189384</span>
            </p>
        </div>
    </div>
...
<a href="bang-gia" target="blank">Bảng Báo Giá</a>
</div>
