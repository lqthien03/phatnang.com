...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.seo_page.video', $video) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <main>
                            ...
                            <section class="content">
                                <div class="row card mb-4 mt-4 ms-1 me-1">
                                    <div class="card-header">
                                        ...
                                        Thông tin SEO page - VideoChi tiết Favicon
                                    </div>
                                    ...
                                    <div>
                                        <div class="mb-3 ms-3 me-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                name="tittle" value="{{ old('tittle') ?? $video->tittle }}">
                                        </div>
                                        <div class="mb-3 ms-3 me-3">
                                            <label for="exampleFormControlInput1" class="form-label"><b>SEO Keywords
                                                    (vi):</b></label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                name="keyword" value="{{ old('keyword') ?? $video->keyword }}">
                                        </div>
                                        <div class="mb-3 ms-3 me-3">
                                            <label for="exampleFormControlTextarea1" class="form-label"><b>SEO
                                                    Description
                                                    (vi):</b></label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description">{{ old('description') ?? $video->description }}</textarea>
                                        </div>
                                    </div>
