                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <img class="center-image"
                                                    src="{{ URL::asset('uploads/' . $product->image) }}"
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-3 mb-3 ms-3 me-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                ...
                                                value="{{ old('product_code') ?? $product->first()->product_code }}">
                                        </div>
                                        <div class="col-3 mb-3 ms-3 me-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                ...
                                                value="{{ old('price') ?? $product->first()->price }}">
                                        </div>
                                        ...
                                        <div class="col-3 mb-3 ms-3 me-3">
                                            ...
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                ...
                                                value="{{ old('new_price') ?? $product->first()->new_price }}">
                                        </div>
                                    </div>
                                    <div class="col-2 mb-3 ms-3 me-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            ...
                                            value="{{ old('discount') ?? $product->first()->discount }}">
                                    </div>
                                ...
                                <div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>SEO Title
                                                (vi):</b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="tittle" value="{{ old('tittle') ?? $product->seo->tittle }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>SEO Keywords
                                                (vi):</b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="keyword" value="{{ old('keyword') ?? $product->seo->keyword }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlTextarea1" class="form-label"><b>SEO
                                                Description
                                                (vi):</b></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description">{{ old('description') ?? $product->seo->description }}</textarea>
                                    </div>
                                </div>
