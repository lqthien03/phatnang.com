...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.policy', $policy) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <main>
                                        ...
                                        <div class="card mt-5">
                                            <div class="card-header">
                                                ...
                                                <img class="center-image"
                                                    src="{{ URL::asset('uploads/' . $policy->image) }}" alt="hình ảnh"
