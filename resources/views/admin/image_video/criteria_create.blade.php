...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('store.criteria') }}" method="post" enctype="multipart/form-data">
                @csrf
                <main>
                                ...
                                <div class="card mb-4 mt-4">
                                    ...
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlTextarea1" class="form-label"><b>Mô
                                                tả:</b></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="describe"></textarea>
                                    </div>
                                </div>
