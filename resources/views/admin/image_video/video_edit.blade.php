                            ...
                            <section class="content">
                                <div class="card mb-4 mt-4">
                                    ...
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>Link
                                                video:</b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            placeholder="" name="link" value="{{ old('link') ?? $video->link }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>
                                                Video preview:</b><br>
                                            <video class="video-stream html5-main-video" src=""
