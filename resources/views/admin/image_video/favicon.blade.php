...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.favicon', $favicon) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <main>
                                ...
                                <div class="row card mb-4 mt-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <form action="/upload-endpoint" method="post"
                                                    ...
                                                    @csrf
                                                    <img src="{{ URL::asset('uploads/' . $favicon->image) }}"
                                    ...
                                    <div class="form-check mb-3 ms-3 me-3">
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            value="{{ old('display') ?? $favicon->first()->display }}"
                                            id="flexCheckDefault" name="display"
                                            {{ $favicon->first()->display == 1 ? 'checked' : '' }}>
