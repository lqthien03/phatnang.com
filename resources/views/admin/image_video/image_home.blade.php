...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.image-home', $image_home) }}" method="post"
                            ...
                            <section class="content">
                                <div class="row card mb-4 mt-4">
                                    <div class="card-header">
                                        ...
                                        Chi tiết hình ảnh chia sẻ trang chủ
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <form action="/upload-endpoint" method="post"
                                                    ...
                                                    @csrf
                                                    <img src="{{ URL::asset('uploads/' . $image_home->image) }}"
                                    ...
                                    <div class="form-check mb-3 ms-3 me-3">
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            value="{{ old('display') ?? $image_home->first()->display }}"
                                            id="flexCheckDefault" name="display"
                                            {{ $image_home->first()->display == 1 ? 'checked' : '' }}>
