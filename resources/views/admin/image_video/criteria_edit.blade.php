...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.criteria', $criteria) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <main>
                                ...
                                <div class="card mb-4 mt-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <form action="/upload-endpoint" method="post"
                                                    ...
                                                    @csrf
                                                    <img src="{{ URL::asset('uploads/' . $criteria->image) }}"
                                    ...
                                    <div class="form-check mb-3 ms-3 me-3">
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            value="{{ old('display') ?? $criteria->first()->display }}"
                                            id="flexCheckDefault" name="display"
                                            {{ $criteria->first()->display == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3 ms-3 me-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            ...
                                            value="{{ old('tittle') ?? $criteria->first()->tittle }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlTextarea1" class="form-label"><b>Mô
                                                tả:</b></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="describe">{{ old('describe') ?? $criteria->first()->describe }}</textarea>
                                    </div>
                                </div>
