...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.news', $news) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <main>
                    <input type="hidden" name="seo_id" value="{{ $news->first()->seo_id }}">
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-3 ms-3 me-3">
                                            <label for="exampleFormControlTextarea1" class="form-label"><b>Mô
                                                    tả</b></label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="describe">{{ old('describe') ?? $news->describe }}</textarea>
                                        </div>
                                        <div class="mb-3 ms-3 me-3">
                                            <label for="exampleFormControlTextarea1" class="form-label"><b>Nội dung
                                                </b></label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="content">{{ old('content') ?? $news->content }}</textarea>
                                        </div>
                                        <div class="form-check mb-3 ms-3 me-3">
                                            <input type="hidden" type="0" name="display">
                                            <input class="form-check-input" type="checkbox"
                                                value="{{ old('display') ?? $news->first()->display }}"
                                                id="flexCheckDefault" name="display"
                                                {{ $news->first()->display == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="card mt-5">
                                            <div class="card-header">
                                                ...
                                                <img class="center-image"
                                                    src="{{ URL::asset('uploads/' . $news->image) }}" alt="hình ảnh"
                                ...
                                <div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>SEO Title
                                                (vi):</b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="tittle" value="{{ old('tittle') ?? $seo->tittle }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>SEO Keywords
                                                (vi):</b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="keyword"value="{{ old('keyword') ?? $seo->keyword }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlTextarea1" class="form-label"><b>SEO
                                                Description
                                                (vi):</b></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description">{{ old('description') ?? $seo->description }}</textarea>
                                    </div>
                                </div>
