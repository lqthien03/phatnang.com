...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.quotation1', $level1_Quotation) }}" method="post"
                            ...
                            <section class="content">
                                <div class="card mb-4 mt-4">
                                    <div class="card-header">
                                        ...
                                        Nội dung sản phẩm
                                        <input type="hidden" name="seo_id" value="{{ $level1_Quotation->seo_id }}">
                                    </div>
                                    <div>
                                        ...
                                        <div class="card mt-5">
                                            <div class="card-header">
                                                ...
                                                <img class="center-image"
                                                    src="{{ URL::asset('uploads/' . $level1_Quotation->image) }}"
                            ...
                            <div class="card mb-4 mt-4">
                                ...
                                <div>
                                    <div class="mb-3 ms-3 me-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="tittle"
                                            value="{{ old('tittle') ?? $level1_Quotation->seo->tittle }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="keyword"
                                            value="{{ old('keyword') ?? $level1_Quotation->seo->keyword }}">
                                    </div>
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlTextarea1" class="form-label"><b>SEO
                                                Description
                                                (vi):</b></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description">{{ old('description') ?? $level1_Quotation->seo->description }}</textarea>
                                    </div>
                                </div>
