...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.static_page.footer', $footer) }}" method="post"
                        ...
                        <div class="">
                            ...
                            <section class="content">
                                <div class="card mb-4 mt-4">
                                    ...
                                    <input type="hidden" name="seo_id" value="{{ $footer->first()->seo_id }}">
                                    <div>
                                        <div class="mb-3 ms-3 me-3">
                                            <label for="exampleFormControlInput1" class="form-label"><b>Tiêu
                                                    đề</b></label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1"
                                                placeholder="" value="{{ old('tittle') ?? $footer->first()->tittle }}"
                                                name="tittle">
                                        </div>
                                        <div class="mb-3 ms-3 me-3">
                                            <label for="exampleFormControlTextarea1" class="form-label"><b>Mô
                                                    tả</b></label>
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="content">{{ old('describe') ?? $footer->first()->content }}</textarea>
                                        </div>
                                        <div class="form-check mb-3 ms-3 me-3">
                                            <input type="hidden" type="0" name="display">
                                            <input class="form-check-input" type="checkbox"
                                                value="{{ old('display') ?? $footer->first()->display }}"
                                                id="flexCheckDefault" name="display"
                                                {{ $footer->first()->display == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="card mt-5">
                                            <div class="card-header">
                                                ...
                                                <img class="center-image"
                                                    src="{{ URL::asset('uploads/' . $footer->image) }}" alt="hình ảnh"
