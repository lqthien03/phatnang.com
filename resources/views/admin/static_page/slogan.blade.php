                ...
                <main>
                    <div id="" class="container-fluid px-4 row">
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-danger mt-3"><a href="/slogan/1">Làm
                                    lại</a></button>
                            <section class="content">
                                <div class="card mb-4 mt-4" style="height: 200px">
                                    <div class="card-header">
                                        <i class="fas fa-table me-1"></i>
                                        Nội dung Slogan tin tức & video
                                    ...
                                    <div class="mb-3 ms-3 me-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            ...
                                            value="{{ old('tittle') ?? $slogan->tittle }}">
                                    </div>
                                    <div class="form-check mb-3 ms-3 me-3">
                                        <input type="hidden" value="0" name="display">
                                        <input class="form-check-input" type="checkbox"
                                            value="{{ old('display') ?? $slogan->first()->display }}" name="display"
                                            id="flexCheckDefault"
                                            {{ $slogan->first()->display == 1 ? 'checked' : '' }}>
