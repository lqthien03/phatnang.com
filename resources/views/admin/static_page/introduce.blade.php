                    ...
                    <div class="col-8">
                        ...
                        <section class="content">
                            <div class="card mb-4 mt-4">
                                ...
                                <div id="editor">
                                    <div class="mb-3 ms-3 me-3">
                                        <label for="exampleFormControlInput1" class="form-label"><b>Bộ soạn thảo văn bản</b></label>
                                            <textarea class="form-control" id="editor" rows="3">{{$in->content}}</textarea>
                                    </div>
                                </div>
