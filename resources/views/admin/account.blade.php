...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <form action="{{ route('update.account', $account) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <main>
                                    ...
                                    <div class="">
                                        <div class="row">
                                            <div class="col mb-3 ms-3 me-3">
                                                <label for="exampleFormControlInput1" class="form-label"><b>Tài
                                                        khoản:</b></label>
                                                <input type="text" class="form-control"
                                                    id="exampleFormControlInput1" placeholder=""
                                                    value="{{ old('role') ?? $account->first()->role }}"
                                                    name="role">
                                            </div>
                                            <div class="col mb-3 ms-3 me-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="exampleFormControlInput1" placeholder=""
                                                    value="{{ old('name') ?? $account->first()->name }}"
                                                    name="name">
                                            </div>
                                            <div class="col mb-3 ms-3 me-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="exampleFormControlInput1" placeholder=""
                                                    value="{{ old('email') ?? $account->first()->email }}"
                                                    name="email">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3 ms-3 me-3">
                                                <label for="exampleFormControlInput1"
                                                    class="form-label"><b>phone:</b></label>
                                                <input type="text" class="form-control"
                                                    id="exampleFormControlInput1" placeholder=""
                                                    value="{{ old('phone') ?? $account->first()->phone }}"
                                                    name="phone">
                                            </div>

                                            <div class="col">
                                                <div class="mb-3 ms-3 me-3">
                                                    <label for="exampleFormControlInput1" class="form-label"><b>Giới
                                                            tính</b></label>
                                            ...
                                            <div class="col mb-3 ms-3 me-3">
                                                <label for="exampleFormControlInput1" class="form-label"><b>Ngày
                                                        sinh</b></label>
                                                <input type="date" class="form-control"
                                                    id="exampleFormControlInput1" placeholder=""
                                                    value="{{ old('date') ?? $account->first()->date }}"
                                                    name="date">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3 ms-3 me-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="exampleFormControlInput1" placeholder=""
                                                    value="{{ old('address') ?? $account->first()->address }}"
                                                    name="address">
                                            </div>
                                            <div class="col"></div>
                                            <div class="col"></div>
