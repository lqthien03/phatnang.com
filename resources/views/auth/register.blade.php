                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="{{ route('register') }}" method="POST" class="login-form">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control rounded-left" placeholder="Tên" name="name"
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control rounded-left" placeholder="Xác nhận mật khẩu"
