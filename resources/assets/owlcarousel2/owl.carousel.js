! function(h, i, n, a) {
    ...
    l.Defaults = {
        ...
        l.prototype.registerEventHandlers = function() {
            h.support.transition && this.$stage.on(h.support.transition.end + ".owl.core", h.proxy(this.onTransitionEnd, this)), !1 !== this.settings.responsive && this.on(i, "resize", this._handlers.onThrottledResize),
        ...
        l.prototype.destroy = function() {
            for (var t in this.$element.off(".owl.core"),
                    ...
                    h(n).off(".owl.core"), !1 !== this.settings.responsive && (i.clearTimeout(this.resizeTimer),
    ...
    s.Defaults = {
        ...
        s.prototype.thumbnail = function(e, t) {
            ...
            if (e.wrap(c("<div/>", {
                ...
                return l(o.attr(r)),
                    o.remove(), !1;
            "youtube" === t.type ? (s = "//img.youtube.com/vi/" + t.id + "/maxresdefault.jpg",
...
function(n, t, e, o) {
    ...
    function h(t) {
        return s(t, !0)
    }!!s("transition") && (n.support.transition = new String(h("transition")),
            n.support.transition.end = i.transition.end[n.support.transition]), !!s("animation") && (n.support.animation = new String(h("animation")),
            n.support.animation.end = i.animation.end[n.support.animation]),
        s("transform") && (n.support.transform = new String(h("transform")),
